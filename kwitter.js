...
function addUser(){
    ...
    useruser_namename= document.getElementById("user_name").value
    localStorage.setItem("useruser_namename", useruser_namename)
    window.location="kwitter_room.html"
    firebase.database().rel("/").child(useruser_namename).update({purpose: "adding user"})
